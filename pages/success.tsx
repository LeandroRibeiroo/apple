  ...
  return (
    <div>
      ...
      <main className="grid grid-cols-1 lg:grid-cols-9">
        <section
          className="order-2 mx-auto max-w-xl pb-12 lg:col-span-5 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16
          xl:pl-16 2xl:pl-44"
        >
          <Link href="/">
          ...
          <div className="rouded-md mx-4 divide-y divide-gray-300 border border-gray-300 p-4 lg:ml-14">
            <div className="space-y-2 pb-3">
              <p>Your order ir confirmed.</p>
              <p className="text-sm text-gray-600">
        ...
        {mounted && (
          <section
            className="lg:bordery-0 overflow-y-scroll border-y border-l 
            border-gray-300 bg-[#FAFAFA] lg:order-2 lg:col-span-4 lg:h-screen"
          >
            <div
              className={`w-full ${
            ...
            >
              <div className="flex- mx-auto max-w-xl items-center justify-between px-4 py-6">
                <button
                ...
                <div className="space-y-4 pb-4">
                    ...
                    >
                      ...
                      >
                        <div className="relative h-7 w-7 animate-bounce rounded-md">
                          <Image
                            alt={`Picture of product ${item.description}`}
                            fill
                  ...
                  <div className="space-y-1 p-4">
                    <div className="flex justify-between text-sm">
                      <p className="text-[gray]">Subotal</p>
...
export const getServerSideProps: GetServerSideProps<Props> = async ({
  ...
  const products = await fetchLineItems(sessionId as string)
